...
function Header() {
  ...
  return (
    <heade ref={headerRef} className="w-full h-[80px] leading-[80px] flex items-center">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className='flex items-center gap-[10px] '>
                    ...
                    <div className="leading-[20px] ">
                        <h2 className='text-xl text-smallTextColor font-[700] '>Yaasiin</h2>
                        <p className='text-smallTextColor text-[18px] font-[500] '>Ahmed</p>
                    </div>
                </div>
                {/*  ========= logo end ======= */}
                {/*  ========= menu start ======= */}
