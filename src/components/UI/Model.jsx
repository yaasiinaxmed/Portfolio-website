...
function Model({ activeID, setShowModal }) {
  ...
  return (
    <div className="w-full h-full fixed top-0 left-0 z-20 bg-headingColor bg-opacity-40">
      <div
      ...
      >
        ...
        <div>
          ...
          <a href={portfolio.siteUrl}>
            <button
              className="bg-primaryColor text-white py-2 px-4 my-4 rounded-[8px] font-[500]
